...
public class Juego {
   ...
   /*     this.barcos.add(new Barco("PortaAviones", 4, false));
        ...
        this.barcos.add(new Barco("Crucero3", 5, false, 6));
        this.barcos.add(new Barco("Submarino1", 4, false, 7));
        this.barcos.add(new Barco("Submarino2", 3, false, 8));
        this.barcos.add(new Barco("Submarino3", 2, false, 9));
